                ...
                <div className="module-inner">
                  ...
                  <div className="content-panel">
                    <form
                      ...
                      onSubmit={this.props.prop.onSubmit}
                    >
                      <fieldset className="fieldset">
                        <hr
                          style={{ marginTop: "100px" }}
                          id="seven"
                          data-symbol="Personal Info"
                        ></hr>
                        ...
                        <div className="form-group avatar">
                          ...
                          /> */}
                            ...
                            <Button
                              variant="primary"
                              onClick={this.props.prop.handleUpload}
                            >
                              Update Image
                            </Button>
                            {/* <button
                          ...
                          <div className="col-md-10 col-sm-9 col-xs-12">
                            <div class="d-flex flex-nowrap">
                              ...
                              <select
                                ...
                                onChange={this.props.prop.changeParentRelation}
                        ...
                        <div className="form-group">
                          ...
                          <div className="col-md-10 col-sm-9 col-xs-12">
                            ...
                            <label
                              ...
                              htmlFor="exampleRadios1"
                            >
                            <p style={{marginTop:"5px"}}>Female</p>
                            </label>
                            &nbsp;
                            <input
                              className="form-check-input"
                              ...
                              value="Female"
                              checked={
                                this.props.prop.state.gender === "Female"
                              }
                              onChange={this.props.prop.changeGender}
                            ></input>
                          </div>
